...
export const getDatoCmsToken = (): string => {
  ...
  switch (hostname) {
    case 'ror.cheesybit-v2.netlify.app':
    case 'cheesybit-v2.netlify.app':
    case 'ror.localhost':
    case 'localhost':
      return '41c30f33cba9ff368371a8f58802fd';
      
    case 'java.cheesybit-v2.netlify.app':
    case 'java.localhost':
      return '9cfd2ca8c261429a7caa55ea0587a7';

    case 'frontend.cheesybit-v2.netlify.app':
    case 'frontend.localhost':
      return 'ee1351644972ae7c3b89db9cf7314b';

    case 'node.cheesybit-v2.netlify.app':
    case 'node.localhost':
