...
const App: React.FC = () => {
  return (
    <Routes>
      ...
      <Route path="/Career-Gap" element={<Layout><CareerGap /></Layout>} />
      ...
      {/* Updated dynamic route for streaming with optional season and episode */}
      <Route path="/stream/:videoName/:season?/:episode?" element={<Stream />} />
    </Routes>
  );
};
